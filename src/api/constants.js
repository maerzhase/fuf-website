...
export const API_BASE_PATH = 'https://cockpit.m3000.io/'
...
export const getHeroImageSrc = path => `https://cockpit.m3000.io/storage/uploads/${path}`
export const getImageSrc = path => `https://cockpit.m3000.io/${path}`