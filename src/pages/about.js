  ...
  return (
    <div className={classes.person}>
      <LeftColumn>
        ...
        <Typography variant="h3" gutterBottom>{person.lastname}</Typography>
      </LeftColumn>
      <RightColumn>
          ...
          <Box>
            ...
            <Box className={classes.collaboratorWrapper} display="flex" mb={4}>
              ...
              <div className={classes.collaborators}>
                {aboutPage.collaborators.map(c => <div className={classes.collaborator} key={c._id}><Collaborator person={c} /></div>)}
              </div>
            </Box>
          </Box>
        </Container>
