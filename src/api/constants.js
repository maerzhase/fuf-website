export const EXAMPLE_PATH = "cms-cockpit";
export const CMS_NAME = "Cockpit";
export const API_BASE_PATH = "https://cockpit.lili16.de/";
export const CMS_URL = "https://getcockpit.com/";
...
export const getHeroImageSrc = (path) =>
  `https://cockpit.lili16.de/storage/uploads/${path}`;
export const getImageSrc = (path) => `https://cockpit.lili16.de/${path}`;
